...
const Publication = () => {
    const listData = [{
        title: "Platform to discover protease-activated antibiotics and application to siderophore–antibiotic conjugates. JACS, 2020, Accepted.(* Co-corresponding author)",
    ...
    {
        title: "Engineered trimeric ACE2 binds viral spike protein and locks it in “Three-up” conformation to potently inhibit SARS-CoV-2 infection. Cell Research, 2020",
    ...
    {
        title:"SNAC-tag for Sequence-specific Chemical Protein Cleavage Nature Methods, 2019, 16, 319-322.",
    ...
    {
        title: "Nav channel binder containing a specific conjugation-site based on a low toxicity β-scorpion toxin. Scientific Reports, 2017, 7, 16329.",
    ...
    {
        title: "Inversion of the Side-Chain Stereochemistry of Indvidual Thr or Ile Residues in a Protein Molecule: Impact on the Folding, Stability, and Structure of the ShK Toxin. Chem. Int. Ed., 2017, 56, 3324-3328.",
    ...
    {
        title: "Photosensitivity of Neurons Enabled by Cell-Targeted Gold Nanoparticles. Neuron, 2015, 86, 207-217. (#Co-first author). Highlighted in Nature, Nature Methods, Nature Review Neuroscience",
    ...
    {
        title: "Total Chemical Synthesis of Biologically Active Fluorescent Dye-Labeled Ts1 Toxin. Angew. Chem. Int. Ed., 2014, 53, 8970-8974. (# Co-first author)",
    ...
    {
        title: "Native Chemical Ligation at Asx-Cys, Glx-Cys: Chemical Synthesis and High-Resolution X-ray Structure of ShK Toxin by Racemic Protein Crystallography. JACS, 2013, 135,11911-11919.",
