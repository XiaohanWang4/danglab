...
const Publication = () => {
    ...
    {
        title: "Rapid clearance of achiral small-molecule drugs using de novo-designed proteins and their cyclic and mirror-image variants. Nat Biomed Eng, 1-13（2025）. ",
