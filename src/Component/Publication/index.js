...
const Publication = () => {
    const listData = [
    {
        title: "Optimizing Solid-Phase Protein Synthesis Using CPG-2000 and a Nickel-Cleavable SNAC-tag Linker. Org Lett, 28, 2104-2109 (2025). ",
    ...
    {
        title: "De novo-designed proteins and derivatives clear small molecule drugs in vivo. Nat Biomed Eng, 2025. ",
        description: "G. Chen#, K. Zhao#, M. Li, Y Zhang, T. Li, J. Yuan, L. Lu, J. Valdiviezo, D. Liu, N. Polizzi*, W. DeGrado*, B. Dang*.",
        content: "Small-molecule-binding proteins can selectively bind and eliminate toxins or cytotoxic drugs with side effects. Despite their significance, the generation of such proteins using traditional approaches poses challenges. While de novo protein design has successfully yielded small molecule-binding proteins, there remains to be shown that any designed protein is useful to bind complex drug molecules for in vivo pharmacology, serving as an antidote to clear toxins or cytotoxic drugs. Apixaban is an anticoagulant drug with bleeding as a major side effect, and rucaparib is a cytotoxic PARP inhibitor for cancer treatment. Here, we present the in vivo pharmacological efficacy of de novo-designed proteins targeting apixaban or rucaparib for clearance in mice, potentially mitigating the side effects of these small molecule drugs. The achiral nature of apixaban allows for the integration of conventional medicinal chemistry techniques, such as mirror-image synthesis and cyclization, with de novo protein design to generate apixaban-binding mirror-image protein and apixaban-binding cyclic protein. Both variants exhibited the intended in vivo functionality, rapidly clearing apixaban. Our findings validate the feasibility of directly designing in vivo functional small molecule-binding proteins, which can be seamlessly integrated with traditional medicinal chemistry strategies for tailored in vivo pharmacology. The concurrent generation of drugs and their binding proteins with embedded in vivo functionality opens new avenues for extended pharmaceutical chemistry, offering innovative solutions for targeted drug clearance."
    },
    {
        title: "An enhanced broad-spectrum peptide inhibits Omicron variants in vivo. Cell Rep Med, 5, 101418 (2024). ",
    ...
    {
        title: "Identification of SARS-CoV-2 PLpro and 3CLpro human proteome substrates using substrate phage display coupled with protein network analysis. J Biol Chem, 2023, 299(6).",
    ...
    {
        title: "A high-throughput fully automatic biosensing platform for efficient COVID-19 detection. Biosens Bioelectron, 2023, 220: 114861.",
    ...
    {
        title: "Zfp106 binds to G-quadruplex RNAs and inhibits RAN translation and formation of RNA foci caused by G4C2 repeats. PNAS, 2024, 121, e2220020121.",
